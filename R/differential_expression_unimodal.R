ribbon_de_unimodal<-function(dataa1,dataa2)
{
...
statistic[as.numeric(names11)]<-stat11+statt11
statistic[as.numeric(names12)]<-stat12+statt12
statistic[as.numeric(names21)]<-stat21+statt21
statistic[as.numeric(names22)]<-stat22+statt22
statistic[as.numeric(names31)]<-stat31+statt31
statistic[as.numeric(names32)]<-stat32+statt32

pval<-1-pchisq(statistic,3)
